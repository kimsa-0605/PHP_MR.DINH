...
if ($resultContacts) {
    $row = mysqli_fetch_assoc($resultContacts);
    $newContacts = $row['newContacts']; // Sử dụng biến khác để lưu kết quả
} else {
    $newContacts = 0; // Nếu không có kết quả, đặt giá trị mặc định
}
?>
